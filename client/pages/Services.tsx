  ...
  const services = [
    {
      ...
      description: "Permohonan izin untuk mendirikan bangunan baru atau renovasi bangunan existing",
      category: "building",
    ...
    },
    {
      ...
      description: "Izin tempat usaha yang berpotensi menimbulkan gangguan lingkungan",
      category: "business",
    ...
    },
    {
      ...
      description: "Izin untuk pendirian dan operasional toko modern/minimarket",
      category: "business",
      duration: "14 hari kerja",
      fee: "Berbayar",
      difficulty: "Sedang",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Temukan layanan perizinan yang sesuai dengan kebutuhan Anda. 
            Semua proses dapat dilakukan secara online dengan mudah dan transparan.
          </p>
        </div>
        ...
        <Alert className="mb-8">
          ...
          <AlertDescription>
            <strong>Tips:</strong> Pastikan Anda menyiapkan semua dokumen yang diperlukan sebelum mengajukan permohonan. 
            Dokumen yang tidak lengkap akan memperlambat proses persetujuan.
          </AlertDescription>
        </Alert>
          ...
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                sesuai dengan kebutuhan usaha atau proyek Anda.
              </p>
