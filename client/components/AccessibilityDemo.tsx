...
import { CheckCircle, Moon, Sun, Monitor, Keyboard, Eye, Volume2 } from 'lucide-react';
      ...
      <CardContent className="space-y-4">
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
            <li>• Tekan <kbd className="px-1 py-0.5 bg-blue-200 dark:bg-blue-800 rounded text-xs">Tab</kbd> untuk navigasi</li>
            <li>• Tekan <kbd className="px-1 py-0.5 bg-blue-200 dark:bg-blue-800 rounded text-xs">Enter</kbd> untuk aktivasi</li>
            <li>• Tekan <kbd className="px-1 py-0.5 bg-blue-200 dark:bg-blue-800 rounded text-xs">Esc</kbd> untuk tutup menu</li>
