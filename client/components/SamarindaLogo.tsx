...
export function SamarindaLogo({ className = "", size = 40 }: SamarindaLogoProps) {
  return (
    <div className={`flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
      ...
      >
        ...
        <path
          d="M50 30L45 40L50 50L55 40L50 30Z"
          fill="#FFD700"
        />
        
        {/* Traditional pattern lines */}
        <line x1="35" y1="45" x2="40" y2="45" stroke="#FFD700" strokeWidth="2" />
        <line x1="60" y1="45" x2="65" y2="45" stroke="#FFD700" strokeWidth="2" />
        <line x1="35" y1="55" x2="40" y2="55" stroke="#FFD700" strokeWidth="2" />
        <line x1="60" y1="55" x2="65" y2="55" stroke="#FFD700" strokeWidth="2" />
